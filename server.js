...
app.get('/sesion', (req, res) => {
    const sesion = sesionController.getSesion();
    res.render('sesion', { title : 'Inicio de sesion'});
})

app.post('/procesar-sesion', (req, res) => {
    const carrito = req.session.sesion || [];
    req.session.sesion = [];
    
    res.render('s-sesion', { title: 'Sesion iniciada exitosa mente' });
});
